...
package org.sonatype.nexus.timeline.rest.feeds.sources;
...
import org.sonatype.nexus.timeline.feeds.NexusArtifactEvent;
import org.sonatype.nexus.timeline.feeds.RepositoryIdTimelineFilter;
 ...
 * @author cstamas
 */
@Named(RecentCachedOrDeployedFileFeedSource.CHANNEL_KEY)
@Singleton
    ...
    extends AbstractNexusItemEventFeedSource
{
  ...
  @Inject
  public RecentCachedOrDeployedFileFeedSource(final @Named("file") SyndEntryBuilder<NexusArtifactEvent> entryBuilder) {
